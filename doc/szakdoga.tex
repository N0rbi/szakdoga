...
Ezen kívül egy idõ után elkerülhetetlen a már említett túltanulás jelensége, ekkor azt fogjuk látni, hogy a validációs halmazon elkezd nõni a hibaérték, még a tanulóhalmazon csökken. Erre egy konkrét esetet mutat be a \ref{over-learn} ábra.
...
Ez különösen igaz zeneszövegekre, ahol a szám csak metaadatként jelenik meg (például: `(3x)'), és ez magyarázza azt is, hogy a különleges karakterek miért kerültek olyan közel a számokhoz.
