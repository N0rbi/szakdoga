% LaTeX mintafï¿½jl szakdolgozat ï¿½s diplomamunkï¿½knak az
% SZTE Informatikai Tanszekcsoportja ï¿½ltal megkï¿½vetelt
% formai kï¿½vetelmï¿½nyeinek megvalï¿½sï¿½tï¿½sï¿½hoz
% Modositva: 2011.04.28 Nemeth L. Zoltan
% A fï¿½jl hasznï¿½latï¿½hoz szï¿½ksï¿½ges a magyar.ldf 2005/05/12 v1.5-ï¿½s vagy kï¿½sï¿½bbi verziï¿½ja
% ez letï¿½lthetï¿½ a http://www.math.bme.hu/latex/ weblaprï¿½l, a magyar nyelvï¿½ szedï¿½shez
% Hasznos informï¿½ciï¿½k, linekek, LaTeX leirasok a www.latex.lap.hu weboldalon vannak.
%
\documentclass[12pt]{report}

%Magyar nyelvi tï¿½mogatï¿½s (Babel 3.7 vagy kï¿½sï¿½bbi kell!)
\def\magyarOptions{defaults=hu-min}
\usepackage[magyar]{babel}

%Az ï¿½kezetes betï¿½k hasznï¿½latï¿½hoz:
\usepackage{t1enc}% ï¿½kezetes szavak automatikus elvï¿½lasztï¿½sï¿½hoz
\usepackage[latin2]{inputenc}% ï¿½kezetes szavak bevitelï¿½hez

% A formai kovetelmenyekben megkï¿½vetelt Times betï¿½tï¿½pus hasznalata:
\usepackage{times}
...
%A fejlï¿½c lï¿½blï¿½cek kialakï¿½tï¿½sï¿½hoz:
\usepackage{fancyhdr}
...
%Tï¿½telszerï¿½ kï¿½rnyezetek definiï¿½lhatï¿½k, ezek most fejezetenkent egyutt szamozodnak, pl.
\newtheorem{tï¿½t}{Tï¿½tel}[chapter]
\newtheorem{defi}[tï¿½t]{Definï¿½ciï¿½}
\newtheorem{lemma}[tï¿½t]{Lemma}
\newtheorem{ï¿½ll}[tï¿½t]{ï¿½llï¿½tï¿½s}
\newtheorem{kï¿½v}[tï¿½t]{Kï¿½vetkezmï¿½ny}

%Ha a megjegyzï¿½sek ï¿½s a pï¿½ldak szï¿½vegï¿½t nem akarjuk dï¿½lten szedni, akkor
%az alï¿½bbi parancs utï¿½n kell ï¿½ket definiï¿½lnï¿½:
\theoremstyle{definition}
\newtheorem{megj}[tï¿½t]{Megjegyzï¿½s}
\newtheorem{pld}[tï¿½t]{Pï¿½lda}
...
%A FEJEZETEK KEZDï¿½OLDALAINAK FEJ ES Lï¿½BLï¿½CE:
%a plain oldalstï¿½lust kell ï¿½tdefiniï¿½lni, hogy ott ne legyen fejlï¿½c:
\fancypagestyle{plain}{%
%ez mindent tï¿½rï¿½l:
\fancyhf{}
% a lï¿½blï¿½cbe jobboldalra kerï¿½ljï¿½n az oldalszï¿½m:
\fancyfoot[R]{\thepage}
%elvï¿½lasztï¿½ vonal sem kell:
\renewcommand{\headrulewidth}{0pt}
}

%A Tï¿½BBI OLDAL FEJ ï¿½S Lï¿½BLï¿½CE:
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{Zeneszï¿½vegek generï¿½lï¿½sa karakteralapï¿½ rekurrens neurï¿½lis hï¿½lï¿½zatok segï¿½tsï¿½gï¿½vel}
\fancyfoot[R]{\thepage}


%A cï¿½moldalra se fej- se lï¿½blï¿½c nem kell:
\thispagestyle{empty}

\begin{center}
\vspace*{1cm}
{\Large\bf Szegedi Tudomï¿½nyegyetem}

\vspace{0.5cm}

{\Large\bf Informatikai Intï¿½zet}
...
%ï¿½rtelemszerï¿½en megvï¿½ltoztatandï¿½:
{\large
\begin{tabular}{c@{\hspace{4cm}}c}
\emph{Kï¿½szï¿½tette:}     &\emph{Tï¿½mavezetï¿½:}\\
\bf{Kis-Szabï¿½ Norbert}  &\bf{Berend Gï¿½bor}\\
programtervezï¿½ informatika     &Szï¿½mï¿½tï¿½gï¿½pes Algoritmusok ï¿½s\\
szakos hallgatï¿½               &Mestersï¿½ges Intelligencia Tanszï¿½k\\
\end{tabular}
}
...
(zene)szövegek ge\-ne\-rá\-lá\-sá\-ra képes karakterszintû nyelvi modellek létrehozása 
rekurrens neurális hálók se\-gít\-sé\-gé\-vel Keras környezetben TensorFlow backend 
használata mellett.
...
Ezek ismeretében már olvasható a TensorBoard vi\-zu\-a\-li\-zá\-ci\-ó\-ja, így megmutatom a tanítások eredményeit.
...
Minden mély háló õse az elõrecsatolt mes\-ter\-sé\-ges neurális háló, így a dolgozatban használt rekurrens, azaz hosszú távú memóriával rendel\-kezõ háló az LSTM alapja is.
...
Alapból c++ -hoz készítették, valamint egy Python interfészen keresztül kényelmesen fejleszthetõ, gyorsaság romlása nélkül, mert a Python is a mo\-tor\-ház\-te\-tõ alatt ezt a c++ -os optimalizált könyvtárat használja. 
...
Ezen felül el\-osz\-tott rend\-szer\-eket is támogatja.
...
mivel a Python rendelkezik magas szintû adatszerkezetek pl: generátor, inline for ciklus, trenary operátor egy em\-ber\-i\-leg olvashatóbb formája.
...
A Keras elõredefiniált optimalizálói a \textit{keras.optimizers}-ben találhatóak, és a \ref{loss} táblázat mutatja a kerasban található optimalizálókat.
...
\chapter*{Nyilatkozat}
%Egy ï¿½res sort adunk a tartalomjegyzï¿½khez:
\addtocontents{toc}{\ }
\addcontentsline{toc}{section}{Nyilatkozat}
%\hspace{\parindent}

% A nyilatkozat szï¿½vege mï¿½s titkos ï¿½s nem titkos dolgozatok esetï¿½ben.
% Csak az egyik tipusï¿½ myilatokzatnak kell a dolgozatban szerepelni
% A ponok helyï¿½re az adatok ï¿½rtelemszerï¿½en behelyettesï¿½dendï¿½k es
% a szakdolgozat /diplomamunka szo megfeleloen kivalasztando.


%A nyilatkozat szï¿½vege TITKOSNAK NEM MINï¿½Sï¿½TETT dolgozatban a kï¿½vetkezï¿½:
%A pontokkal jelï¿½lt szï¿½vegrï¿½szek ï¿½rtelemszerï¿½en a szï¿½vegszerkesztï¿½ben ï¿½s
%nem kï¿½zzel helyettesï¿½tendï¿½k:

\noindent
Alulírott programtervezõ szakos hallgató, kijelentem, hogy a dolgozatomat a Sze\-ge\-di Tudományegyetem, Informatikai Intézet Számítógépes Algoritmusok és Mesterséges In\-tel\-li\-gen\-cia Tanszékén készítettem, BSc diploma meg\-szer\-zé\-se érdekében.

Kijelentem, hogy a dolgozatot mï¿½s szakon korï¿½bban nem vï¿½dtem meg, sajï¿½t munkï¿½m eredmï¿½nye, ï¿½s csak a hivatkozott forrï¿½sokat (szakirodalom, eszkï¿½zï¿½k, stb.) hasznï¿½ltam fel.
...
\chapter*{Kï¿½szï¿½netnyilvï¿½nï¿½tï¿½s}
\addcontentsline{toc}{section}{Kï¿½szï¿½netnyilvï¿½nï¿½tï¿½s}
...
Végül de nem utolsó sorban köszönöm \textbf{Szegednek} és a \textbf{Szegedi Tu\-do\-mány\-e\-gye\-tem\-nek} a rengeteg élményt amit az évek során szereztem.
...
%Elso szerzok vezetekneve alapjan ï¿½bï¿½cï¿½rendben rendezve.
